/*
   Demo compression program using LZ4HC compression
...
*/
/*
	Note : this is *only* a demo program, an example to show how LZ4HC can be used.

	License Recap :
	The license of the demo program is GPLv2.
	The license of MMC is GPLv2.
	The license of LZ4HC is GPLv2.
...
// Constants
//****************************
#define COMPRESSOR_NAME "Demo compression program using LZ4HC"
#define COMPRESSOR_VERSION ""
#define COMPILED __DATE__
#define AUTHOR "Yann Collet"
#define BINARY_NAME "LZ4HCDemo.exe"
